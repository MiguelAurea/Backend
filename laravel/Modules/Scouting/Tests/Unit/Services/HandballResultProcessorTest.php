...
use Modules\Scouting\Tests\Fixtures\HandballMatchFixturesTrait;
use Illuminate\Foundation\Testing\DatabaseTransactions;
use Modules\Scouting\Processors\ResultsProcessor;
use Tests\ModuleTestCase;

class HandballResultProcessorTest extends ModuleTestCase
{
    use DatabaseTransactions;
    use HandballMatchFixturesTrait;

    /**
     * @test
     * 
     * Test the results of a handball match that doesnt have
     * any goal activities recorded will return 0 to 0
     * as the score result
     */
    public function a_handball_match_that_doesnt_record_goal_activities_returns_0_0_as_score_result()
    {
     ...
     * @test
     * 
     * Test the results of a handball match that has 2 goals
     * activities recorded will return 1 to 1
     * as the score result
     */
    public function a_handball_match_with_a_goal_recorded_for_each_team_returns_1_1_as_score_result()
    {
