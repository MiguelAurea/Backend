...
class PointsError
{
    const POINT_ERROR_SIDE_EFFECT = 'POINT_ERROR_SIDE_EFFECT';
    ...
    public function point($activity)
    {
        ...
        return $side_effect == self::POINT_ERROR_SIDE_EFFECT || ($side_effect == Shots::SHOT_SIDE_EFFECT && $activity->custom_params == ScoutingActivity::WINNER);
    }
}
