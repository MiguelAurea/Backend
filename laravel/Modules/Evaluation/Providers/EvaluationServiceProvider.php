...
class EvaluationServiceProvider extends ServiceProvider
{
    ...
    protected static $policies = [
        'store-evaluation-rubric' => [
            EvaluationPolicy::class, 'storeRubric'
        ]
    ];
    ...
    public function register()
    {
        ...
        foreach ($services as $service) {
            $this->app->bind(
                "Modules\\Evaluation\\Services\\Interfaces\\{$service}ServiceInterface",
                "Modules\\Evaluation\\Services\\{$service}Service"
            );
        }
    }
