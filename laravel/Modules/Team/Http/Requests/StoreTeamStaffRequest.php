...
class StoreTeamStaffRequest extends FormRequest
{
    /**
     * @OA\Schema(
     *   schema="StoreTeamStaffRequest",
     *   @OA\Property( title="Team", property="team_id", description= "", format="integer", example="1" ),
    ...
    public function rules()
    {
        return [
            ...
            'email' => 'required|string|unique:staff_users',
            'image' => 'nullable|image|mimes:png|dimensions:min_width=512,min_height=512|min:1|max:2048'
        ];
    }
