...
class UpdateSchoolAcademicalYearsRequest extends FormRequest
{
    /**
     * Get the validation rules that apply to the request.
     *
     * * @OA\Schema(
     *  schema="UpdateSchoolAcademicalYearsRequest",
     *  type="object",
     *  @OA\Property(
     ...
     *              type="array",
     *              @OA\Items(
     *                  @OA\Property(property="id", format="integer", example="1"),
     *                  @OA\Property(property="title", format="string", example="string"),
     *                  @OA\Property(property="start_date", format="date", example="2020-01-01"),
     *                  @OA\Property(property="end_date", format="date", example="2020-01-01"),
     *                  @OA\Property(property="is_active", format="boolean", example="1"),
    ...
    public function rules()
    {
        return [
            ...
            'academic_years.*.periods.*.id' => 'integer|exists:academic_periods,id',
