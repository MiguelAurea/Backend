...
class CreateSchoolRequest extends FormRequest
{
     ...
     *  ),
     *  @OA\Property(
     *      title="Academical years json",
     *      property="academic_years_json",
     *      description="Stringfied JSON body information for academic years",
     *      type="string",
     *  ),
     * )
     */
    public function rules()
    {
        return [
            ...
            'school_center_type_id' => 'required|integer|exists:school_center_types,id',
