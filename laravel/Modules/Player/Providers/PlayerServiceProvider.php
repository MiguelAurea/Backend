...
use Modules\Player\Policies\PlayerPolicy;
...
class PlayerServiceProvider extends ServiceProvider
{
     ...
     */
    protected $moduleNameLower = 'player';
    ...
    protected static $policies = [
        'store-player' => [
            PlayerPolicy::class, 'store'
        ],
        'update-player' => [
            PlayerPolicy::class, 'update'
        ],
        'read-player' => [
            PlayerPolicy::class, 'show'
        ],
        'delete-player' => [
            PlayerPolicy::class, 'destroy'
        ],
        'list-player' => [
            PlayerPolicy::class, 'index'
        ]
    ];
