...
class UpdatePlayerContractRequest extends FormRequest
{
    /**
     ...
     * 
     *   @OA\Schema(
     *      schema="UpdatePlayerContractRequest",
     *      required={
     *          "duration",
     *          "contract_creation"
     *      },
     *   @OA\Property(title="Title", property="title", description="title", format="string", example="Contract" ),
     *   @OA\Property(title="Duration", property="duration", description="duration", format="integer", example="2" ),
