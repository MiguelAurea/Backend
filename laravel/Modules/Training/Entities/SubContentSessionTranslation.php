 ...
 *      @OA\Property( title="Sub Content Session", property="sub_content_session_id", description="entity id", format="integer", example="1" ),
 *      @OA\Property( title="Name", property="name", description="translated name", format="string", example="Diet Fit" ) 
 * * )
 */
class SubContentSessionTranslation extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'sub_content_session_translations';
